...
const CorporateActionsPage = () => {
  const upcomingEvents = [
    { id: 1, security: "AAPL", event: "Dividend", date: "2024-08-15", issuer: "Apple Inc.", type: "🟡", amount: "BHD 0.25" },
    ...
    { id: 5, security: "META", event: "Dividend", date: "2024-09-10", issuer: "Meta Platforms", type: "🟡", amount: "BHD 0.50" },
    { id: 6, security: "BOND1", event: "Coupon", date: "2024-09-15", issuer: "Corporate Bond", type: "🟢", amount: "BHD 12.50" },
  ];
