...
// Sample auction data with different types and sources
const auctionData = [
  {
    id: 'A03',
    ...
    endDate: new Date(2024, 1, 15, 16, 0),
    bidDeadline: new Date(2024, 1, 15, 14, 0),
  ...
  },
  {
    ...
    endDate: new Date(2024, 1, 18, 15, 0),
    bidDeadline: new Date(2024, 1, 18, 13, 0),
    settlementDate: new Date(2024, 1, 20),
    amount: 'BHD 100M',
    participants: 12,
    source: 'MOF',
  ...
  },
  {
    ...
    type: 'repo',
    status: 'active',
    startDate: new Date(2024, 1, 14, 11, 0),
    endDate: new Date(2024, 1, 14, 17, 0),
    bidDeadline: new Date(2024, 1, 14, 15, 0),
    settlementDate: new Date(2024, 1, 16),
    amount: 'BHD 75M',
    participants: 6,
    source: 'CBB',
    issueCode: 'REPO001',
  ...
  },
  {
    ...
    type: 'deposit',
    status: 'closed',
    startDate: new Date(2024, 1, 10, 9, 0),
    endDate: new Date(2024, 1, 10, 16, 0),
    bidDeadline: new Date(2024, 1, 10, 14, 0),
    settlementDate: new Date(2024, 1, 12),
    amount: 'BHD 30M',
    participants: 4,
    source: 'CBB',
    issueCode: 'DEP001',
  ...
  },
  {
    ...
    type: 'fx',
    status: 'active',
    startDate: new Date(2024, 1, 16, 8, 0),
    endDate: new Date(2024, 1, 16, 12, 0),
    bidDeadline: new Date(2024, 1, 16, 11, 0),
    settlementDate: new Date(2024, 1, 18),
    amount: 'USD 25M',
    participants: 5,
    source: 'CBB',
    issueCode: 'FX001',
            ...
            <CardContent className="flex items-center p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{filteredAuctions.filter(a => a.status === 'active').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="flex items-center p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{filteredAuctions.filter(a => a.status === 'pending').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="flex items-center p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">BHD 280M</p>
                </div>
              </div>
            </CardContent>
          </Card>
