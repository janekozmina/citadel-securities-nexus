...
const auctionData = [
  // Week 1
  {
    ...
    type: 'primary',
    status: 'closed',
    startDate: new Date(2024, 1, 5, 9, 0),
    endDate: new Date(2024, 1, 5, 16, 0),
    bidDeadline: new Date(2024, 1, 5, 14, 0),
    settlementDate: new Date(2024, 1, 7),
    amount: 'BHD 50M',
    participants: 8,
    source: 'CBB',
  ...
  },
  {
    ...
    type: 'repo',
    status: 'closed',
    startDate: new Date(2024, 1, 6, 11, 0),
    endDate: new Date(2024, 1, 6, 17, 0),
    bidDeadline: new Date(2024, 1, 6, 15, 0),
    settlementDate: new Date(2024, 1, 8),
    amount: 'BHD 75M',
    participants: 6,
    source: 'CBB',
    issueCode: 'REPO001',
  ...
  // Week 2
  {
    ...
    endDate: new Date(2024, 1, 12, 16, 0),
    bidDeadline: new Date(2024, 1, 12, 14, 0),
    settlementDate: new Date(2024, 1, 14),
    amount: 'BHD 30M',
    participants: 4,
    source: 'CBB',
    issueCode: 'DEP001',
  ...
  },
  {
    ...
    type: 'fx',
    status: 'closed',
    startDate: new Date(2024, 1, 13, 8, 0),
    endDate: new Date(2024, 1, 13, 12, 0),
    bidDeadline: new Date(2024, 1, 13, 11, 0),
    settlementDate: new Date(2024, 1, 15),
    amount: 'USD 25M',
    participants: 5,
    source: 'CBB',
    issueCode: 'FX001',
  ...
  },
  {
    ...
    endDate: new Date(2024, 1, 15, 15, 0),
    bidDeadline: new Date(2024, 1, 15, 13, 0),
    settlementDate: new Date(2024, 1, 17),
    amount: 'BHD 100M',
    participants: 12,
    source: 'MOF',
  ...
  // Week 3
  {
    ...
    type: 'repo',
    status: 'active',
    startDate: new Date(2024, 1, 19, 11, 0),
    endDate: new Date(2024, 1, 19, 17, 0),
    bidDeadline: new Date(2024, 1, 19, 15, 0),
    settlementDate: new Date(2024, 1, 21),
    amount: 'BHD 60M',
    participants: 7,
    source: 'CBB',
    issueCode: 'REPO002',
  ...
  },
  {
    ...
    endDate: new Date(2024, 1, 20, 16, 0),
    bidDeadline: new Date(2024, 1, 20, 14, 0),
    settlementDate: new Date(2024, 1, 22),
    amount: 'BHD 80M',
    participants: 9,
    source: 'MOF',
    issueCode: 'SUKUK001',
  ...
  },
  {
    ...
    type: 'deposit',
    status: 'pending',
    startDate: new Date(2024, 1, 21, 10, 0),
    endDate: new Date(2024, 1, 21, 15, 0),
    bidDeadline: new Date(2024, 1, 21, 13, 0),
    settlementDate: new Date(2024, 1, 23),
    amount: 'BHD 45M',
    participants: 6,
    source: 'CBB',
    issueCode: 'TERM001',
  ...
  // Week 4
  {
    ...
    type: 'fx',
    status: 'pending',
    startDate: new Date(2024, 1, 26, 9, 0),
    endDate: new Date(2024, 1, 26, 14, 0),
    bidDeadline: new Date(2024, 1, 26, 12, 0),
    settlementDate: new Date(2024, 1, 28),
    amount: 'USD 40M',
    participants: 8,
    source: 'CBB',
  ...
  },
  {
    ...
    type: 'primary',
    status: 'pending',
    startDate: new Date(2024, 1, 27, 9, 0),
    endDate: new Date(2024, 1, 27, 16, 0),
    bidDeadline: new Date(2024, 1, 27, 14, 0),
    settlementDate: new Date(2024, 1, 29),
    amount: 'BHD 65M',
    participants: 10,
    source: 'CBB',
  ...
  },
  {
    ...
    type: 'repo',
    status: 'pending',
    startDate: new Date(2024, 1, 28, 11, 0),
    endDate: new Date(2024, 1, 28, 17, 0),
    bidDeadline: new Date(2024, 1, 28, 15, 0),
    settlementDate: new Date(2024, 2, 1),
    amount: 'BHD 55M',
    participants: 5,
    source: 'CBB',
    issueCode: 'REPO003',
