...
const routeMap: Record<string, RouteInfo> = {
  ...
  '/csd/instruments/register-cbb-instrument': { path: '/csd/instruments/register-cbb-instrument', label: 'Register CBB Instrument', parent: '/csd/instruments' },
  ...
  '/csd/instruments/issuance-other': { path: '/csd/instruments/issuance-other', label: 'Securities Issuance Other', parent: '/csd/instruments' },
